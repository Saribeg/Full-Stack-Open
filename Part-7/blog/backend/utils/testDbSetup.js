...
const initialDemoData = require('./testData');
  ...
  blogs: [
    {
      ...
      user: 'alex',
      comments: [
        { text: 'Some test comment from anyone with minimum 20 chars long #1' },
        { text: 'Some test comment from anyone with minimum 20 chars long #2' },
        { text: 'Some test comment from anyone with minimum 20 chars long #3' }
      ]
    },
    {
