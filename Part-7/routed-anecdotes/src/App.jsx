...
const Menu = () => {
  return (
    <div>
      <NavLink className={getNavLinkClassName} to="/anecdotes">Anecdotes</NavLink>
      <NavLink className={getNavLinkClassName} to="/create">Create new</NavLink>
...
const Anecdote = ({ anecdote }) => {
  return <li><Link to={`/anecdotes/${anecdote.id}`}>{anecdote.content}</Link></li>
}
